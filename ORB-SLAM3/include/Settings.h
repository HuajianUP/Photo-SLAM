...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        GeometricCamera* originalCamera1() {return originalCalib1_;}
        GeometricCamera* originalCamera2() {return originalCalib2_;}
        ...
        cv::Size originalImSize() {return originalImSize_;}
