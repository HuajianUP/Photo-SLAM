...
namespace ORB_SLAM3 {
    ...
    void Settings::readCamera1(cv::FileStorage &fSettings) {
        ...
        if (cameraModel == "PinHole") {
            ...
            if((sensor_ == System::MONOCULAR || sensor_ == System::IMU_MONOCULAR || sensor_== System::RGBD || sensor_ == System::IMU_RGBD) && vPinHoleDistorsion1_.size() != 0){
