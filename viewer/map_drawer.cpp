...
ImGuiMapDrawer::ImGuiMapDrawer(Atlas* pAtlas, const string &strSettingPath, Settings* settings):mpAtlas(pAtlas)
{
    if(settings){
...
void ImGuiMapDrawer::newParameterLoader(Settings *settings) {
...
bool ImGuiMapDrawer::ParseViewerParamFile(cv::FileStorage &fSettings)
{
...
void ImGuiMapDrawer::DrawMapPoints()
{
...
void ImGuiMapDrawer::DrawCurrentCamera(glm::mat4 &Twc)
{
...
void ImGuiMapDrawer::SetCurrentCameraPose(const Sophus::SE3f &Tcw)
{
    unique_lock<mutex> lock(mMutexCamera);
